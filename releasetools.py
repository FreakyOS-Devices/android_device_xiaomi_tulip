...
def FullOTA_InstallBegin(info):
    ...
    info.script.AppendExtra('ui_print("                                                    ");');
    info.script.AppendExtra('ui_print("    --> Maintainer: Niteshkumar                     ");');
    info.script.AppendExtra('ui_print("    --> Device: Xiaomi Redmi Note 6 Pro             ");');
    info.script.AppendExtra('ui_print("    --> Github: niteshkumar2000                     ");');
    info.script.AppendExtra('ui_print("                                                    ");');
